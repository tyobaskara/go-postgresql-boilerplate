...
func (u *authUsecase) LoginWithPassword(ctx context.Context, email, password string) (*domain.AuthToken, error) {
...
// SignupWithPassword handles password-based user registration
func (u *authUsecase) SignupWithPassword(ctx context.Context, email, name, password string) (*domain.AuthToken, error) {
